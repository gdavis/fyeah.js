function MouseAndTouchTracker ()
{
	...
	this.state_start = 'TOUCH_START';
	this.state_move = 'TOUCH_MOVE';
	this.state_end = 'TOUCH_END';
...
MouseAndTouchTracker.prototype.init = function ( touchObject, delegate )
{
...
//    if( this.is_touch_capable && this.stops_propagation ) touchEvent.stopPropagation();
	...
	if( this.delegate ) this.delegate.touchUpdated( this.state_start, touchEvent );
};
...
MouseAndTouchTracker.prototype.onMove = function ( touchEvent )
{
    ...
    if( this.is_touching ) 
    {
    	...
    	if( this.delegate ) this.delegate.touchUpdated( this.state_move, touchEvent );
    }
};
...
MouseAndTouchTracker.prototype.onEnd = function ( touchEvent )
{
	...
	if( this.delegate ) this.delegate.touchUpdated( this.state_end, touchEvent ); 
...
MouseAndTouchTracker.prototype.findPos = function(obj) {
    ...
    if (obj.offsetParent) {
        do {
            if( obj.parentNode.style.webkitTransform && obj.parentNode.style.webkitTransform.indexOf('translate3d') != -1 )
            {
